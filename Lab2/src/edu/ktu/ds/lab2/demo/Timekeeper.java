...
public class Timekeeper {
    ...
    public void finish(String vardas) throws InterruptedException {
        ...
        //System.out.println("Finis" + System.nanoTime());
       // //System.out.println("Min" + (System.nanoTime() - startTime));
        ...
        tyrimųEilutė += String.format("%9.8f ", executionTime);
        Runtime.getRuntime().gc();
        Runtime.getRuntime().gc();
        Runtime.getRuntime().gc();
        startTime = System.nanoTime();
        //System.out.println("Resta" + startTime);
    }
