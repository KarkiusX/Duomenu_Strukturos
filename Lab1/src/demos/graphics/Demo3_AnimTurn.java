...
//        gc.scale(0.975, 0.975);
    ...
    {
        final String Name = "Karolis";
        int Origin = 0;
        for(int i = 0; i < Name.length(); i++)
        {
            gc.setStroke(randomColor());
            gc.setFill(randomColor(0.9));
            gc.strokeText(Character.toString(Name.charAt(i)), Origin,  Origin, canvasH/2);
            gc.fillText(Character.toString(Name.charAt(i)), Origin,  Origin, canvasH/2);
            Origin += 10;
        }
