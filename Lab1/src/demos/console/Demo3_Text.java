...
// http://www.java2s.com/Tutorials/Java/Java_Regular_Expression/0070__Java_Regex_Groups.htm    
    ...
    *   a - žodžius su lotyniškomis raidėmis // [a-zA-Z]+
    *   b - žodžius su lietuviškomis raidėmis [a-zą-žĄ-Ž]+[ą-žĄ-Ž][a-zą-žĄ-Ž]+
    ...
    ***************************************************/
    void regexExamples(){
        ...
        while (m.find())                     // kol randamas šablonas
            ta2.appendText(m.group(GroupCount) + nL);  // pateikiamas jo atitikmuo
